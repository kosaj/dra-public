...
`}const _=.09,S=480600;function K(e){return Math.round(e*_)}const g=[{label:"przychód do 60 000 zł",revenueFromGr:0,revenueToGr:6e6,contributionGr:49835},{label:"przychód 60 000 – 300 000 zł",revenueFromGr:6e6,revenueToGr:3e7,contributionGr:83058},{label:"przychód powyżej 300 000 zł",revenueFromGr:3e7,revenueToGr:null,contributionGr:149504}];function O(e){return g.find(t=>e>=t.revenueFromGr&&(t.revenueToGr===null||e<=t.revenueToGr))??g[g.length-1]}function W(e,t,n){if(!e)return 0;const r=t.trim();return r===""?n:y(r)}function Z(e,t,n){const r=W(e,t,n);if(e&&t.trim()!==""&&r<n)throw new Error(`kwota nie może być niższa niż minimum ${f(n)} zł`);return r}let c=null;function h(e,t){var r;let n=v(e);for(const a of t)n=n?Array.from(n.children).find(o=>o.localName===a)??null:null;return((r=n==null?void 0:n.textContent)==null?void 0:r.trim())??""}function k(e,t,n){const r=h(e,[t,n]);return r?y(r):0}function J(e){e.innerHTML=`
  ...
  `;const t=e.querySelector("#file"),n=e.querySelector("#drop"),r=e.querySelector("#load-error"),a=e.querySelector("#editor");t.addEventListener("change",()=>{var l;const i=(l=t.files)==null?void 0:l[0];i&&o(i)}),["dragenter","dragover"].forEach(i=>n.addEventListener(i,l=>{l.preventDefault(),n.classList.add("drag")})),["dragleave","drop"].forEach(i=>n.addEventListener(i,l=>{l.preventDefault(),n.classList.remove("drag")})),n.addEventListener("drop",i=>{var d,u;const l=(u=(d=i.dataTransfer)==null?void 0:d.files)==null?void 0:u[0];l&&o(l)});async function o(i){r.classList.add("hidden");try{const l=await i.text(),d=P(l);if(v(d).namespaceURI!==G)throw new Error("Nieoczekiwany namespace — spodziewano się KEDU 5.7.");const u=h(d,["XI","p13"]),z=h(d,["XI","p16"]);c={xml:l,period:h(d,["I","p2","p2"]),payerName:Q(d),social:k(d,"IV","p37"),health:k(d,"VI","p7"),laborFund:k(d,"VII","p3"),total:k(d,"IX","p2"),annual:z?y(z):null,revenue:u?y(u):null},Y(e),a.classList.remove("hidden")}catch(l){c=null,a.classList.add("hidden"),r.textContent=`Nie udało się wczytać pliku: ${l.message}`,r.classList.remove("hidden")}}}function Q(e){const t=h(e,["II","p6"]),n=h(e,["II","p7"]),r=h(e,["II","p8"]);return[t,[r,n].filter(Boolean).join(" ")].filter(Boolean).join(", ")}function Y(e){if(!c)return;const t=e.querySelector("#meta");t.innerHTML=`<strong>${c.payerName||"płatnik"}</strong> · okres <strong>${c.period||"—"}</strong>`,te(e);const n=e.querySelector("#min-wage"),r=e.querySelector("#tax-scale-active"),a=e.querySelector("#tax-scale-amount"),o=e.querySelector("#tax-scale-hint"),i=e.querySelector("#flat-tax-active"),l=e.querySelector("#flat-tax-amount"),d=e.querySelector("#flat-tax-hint"),u=e.querySelector("#input-error"),z=e.querySelector("#preview"),E=e.querySelector("#download");function L(){r.checked||(a.value=""),i.checked||(l.value=""),a.disabled=!r.checked,l.disabled=!i.checked}function M(){const s=y(n.value);if(s<S)throw new Error(`Minimalne wynagrodzenie nie może być mniejsze niż ${f(S)} zł`);return s}function T(s,w,b,$){try{return Z(s,w,$)}catch(q){throw new Error(`${b}: ${q.message}`)}}function A(){const s=K(M());return{minimumGr:s,taxScale:T(r.checked,a.value,"Skala podatkowa",s),flatTax:T(i.checked,l.value,"Podatek liniowy",s)}}function D(s){z.innerHTML="",E.disabled=!0,u.textContent=s,u.classList.remove("hidden")}function I(){if(!c)return;u.classList.add("hidden");let s;try{s=A()}catch($){D($.message);return}const w=`puste = minimum ${f(s.minimumGr)}`;o.textContent=w,d.textContent=w;const b=s.taxScale+s.flatTax;ee(z,b,{taxScale:r.checked?s.taxScale:null,flatTax:i.checked?s.flatTax:null}),E.disabled=b===0}[r,i].forEach(s=>s.addEventListener("change",()=>{L(),I()})),[n,a,l].forEach(s=>s.addEventListener("input",I)),E.addEventListener("click",()=>{let s;try{s=A()}catch(w){D(w.message);return}ne(s.taxScale,s.flatTax)}),L(),I()}function ee(e,t,n){if(!c)return;const r=[],a=(o,i,l,d={})=>{const u=i!==l;return`<tr class="${d.total?"total":""} ${u?"chg":""}">
      <td>${o}</td>
      <td class="val">${f(i)}</td>
      <td class="arr">→</td>
      <td class="val ${u?"after":""}">${f(l)}</td>
    </tr>`};r.push('<tr class="head"><td>Pozycja</td><td class="val">przed (zł)</td><td class="arr"></td><td class="val">po (zł)</td></tr>'),n.taxScale!==null&&r.push(j("Dodano: skala",n.taxScale)),n.flatTax!==null&&r.push(j("Dodano: liniówka",n.flatTax)),r.push(a("Składki społeczne (IV)",c.social,c.social)),r.push(a("Składka zdrowotna (VI)",c.health,c.health+t)),r.push(a("Fundusz Pracy (VII)",c.laborFund,c.laborFund)),r.push(a("Suma do zapłaty (IX)",c.total,c.total+t,{total:!0})),c.annual!==null&&r.push(a("Roczne rozliczenie zdrow. (XI)",c.annual,c.annual)),e.innerHTML=r.join("")}function j(e,t){return`<tr class="added"><td>${e}</td><td class="val delta" colspan="3">+ ${f(t)}</td></tr>`}function te(e){if(!c)return;const t=e.querySelector("#brackets"),n=c.revenue!==null?O(c.revenue):null,r='<tr class="head"><td>Próg (roczny przychód)</td><td class="val">Składka mies. (zł)</td></tr>',a=g.map(o=>{const i=n===o;return`<tr class="${i?"sel":""}">
