...
`}const V=.09,Y=.049,T=480600;function J(e){return Math.round(e*V)}function pe(e,t,n){const r=Math.max(t,n),o=Math.max(Math.round(r*(e==="scale"?V:Y)),J(n));return{podstawaGr:r,contributionGr:o}}const U={2022:{minMonthlyHealthGr:27090,minWageGr:301e3},2023:{minMonthlyHealthGr:31410,minWageGr:349e3},2024:{minMonthlyHealthGr:38178,minWageGr:424200},2025:{minMonthlyHealthGr:31496,minWageGr:466600},2026:{minMonthlyHealthGr:43254,minWageGr:480600}},X=2026;function me(e){return(U[e]??U[X]).minMonthlyHealthGr}const R=[{label:"przychód do 60 000 zł",revenueFromGr:0,revenueToGr:6e6,contributionGr:49835},{label:"przychód 60 000 – 300 000 zł",revenueFromGr:6e6,revenueToGr:3e7,contributionGr:83058},{label:"przychód powyżej 300 000 zł",revenueFromGr:3e7,revenueToGr:null,contributionGr:149504}];function Q(e){return R.find(t=>e>=t.revenueFromGr&&(t.revenueToGr===null||e<=t.revenueToGr))??R[R.length-1]}function fe(e,t,n,r){const o=Math.max(0,Math.round(t*(e==="scale"?V:Y))),s=n*r;return Math.max(o,s)}function _(e){return`luty ${e} – styczeń ${e+1}`}function he(e){return/^\d{4}-04$/.test(e)}function ke(e,t){const n=/^(\d{4})-(\d{2})$/.exec(e);if(!n)return!1;const r=Number(n[1]),a=Number(n[2]);return a<1||a>12?!1:r===t&&a>=2||r===t+1&&a===1}function ye(e,t){return{dueGr:e,paidGr:t,balanceGr:e-t}}function ze(e){const t=new Map;for(const a of e){if(!a.period)continue;const o=t.get(a.period);(!o||a.identifier>o.identifier)&&t.set(a.period,a)}const n=[...t.keys()].sort();return{totalGr:n.reduce((a,o)=>a+t.get(o).healthGr,0),months:n}}const we={k7:/^\d{1,5}\.\d{2}$/,k8:/^\d{1,6}\.\d{2}$/,k9:/^\d{1,7}\.\d{2}$/,k10:/^\d{1,8}\.\d{2}$/,k11:/^\d{1,9}\.\d{2}$/,k12:/^\d{1,10}\.\d{2}$/,k13:/^\d{1,11}\.\d{2}$/,b:/^(true|false|0|1)$/,d:/^\d{4}-\d{2}-\d{2}$/,ym:/^\d{4}-\d{2}$/,y:/^\d{4}$/,kod4:/^\d{4}$/,dig:/^\d$/,id2:/^\d{2}$/,l6:/^\d{1,6}$/,wyp:/^\d{1,2}\.\d{2}$/};function P(e,t,n,r={}){const a={};for(let o=e;o<=t;o++)a[`p${o}`]=n;return{...a,...r}}const be=["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII"],ge={I:{p1:"dig",p2:{p1:"id2",p2:"ym"},p3:"d",p4:"s20",p5:"s12"},II:{p1:"s10",p2:"s14",p3:"s11",p4:"s1",p5:"s9",p6:"s31",p7:"s31",p8:"s22",p9:"d"},III:{p1:"l6",p2:"s1",p3:"wyp"},IV:P(1,36,"k11",{p37:"k12"}),V:P(1,4,"k11",{p5:"k12"}),VI:{...P(1,5,"k11"),p6:"k10",p7:"k12"},VII:{p1:"k11",p2:"k11",p3:"k12"},VIII:{p1:"l6",p2:"l6",p3:"k12"},IX:{p1:"k13",p2:"k13"},X:{p1:{p1:"kod4",p2:"dig",p3:"dig"},p2:"k10",p3:"k10",p4:"k10",p5:"k10",p6:"s1"},XI:{p1:"b",p2:"k10",p3:"k10",p4:"k10",p5:"b",p6:"k10",p7:"k10",p8:"k10",p9:"b",p10:"k10",p11:"k10",p12:"b",p13:"k10",p14:"b",p15:"k10",p16:"k10",p17:"k10",p18:"b",p19:"k10",p20:"k10"},XII:{p1:"y",p2:"b",p3:"b",p4:"b",p5:"k11",p6:"b",p7:"k11",p8:"k11",p9:"k11",p10:"k11",p11:"k11",p12:"k11",p13:"b",p14:"k11",p15:"b",p16:"k11",p17:"k11",p18:"k11",p19:"k11",p20:"k11",p21:"b",p22:"k11",p23:"k11",p24:"k11",p25:"k11",p26:"k11",p27:"k11",p28:"k11",p29:"k11"},XIII:{p1:"d"}},ve=new Set(["identyfikacja.PL","identyfikacja.UB","naglowek.DP","cechy.DP","cechy.BL","stopka.DP"]);function Ie(e,t,n,r){if(t[0]==="s"){const o=Number(t.slice(1));Number.isFinite(o)&&e.length>o&&r.push({path:n,message:`wartość za długa (max ${o} znaków)`});return}const a=we[t];a&&(a.test(e.trim())||r.push({path:n,message:`"${e}" nie pasuje do formatu (${t})`}))}function ee(e,t,n,r){for(const a of Array.from(e.children)){const o=t[a.localName];if(o===void 0){r.push({path:`${n}/${a.localName}`,message:"nieznane pole"});continue}typeof o=="object"?a.children.length&&ee(a,o,`${n}/${a.localName}`,r):Ie(a.textContent??"",o,`${n}/${a.localName}`,r)}}function $e(e){const t=[],n=e.documentElement;if(!n||n.localName!=="KEDU")return[{path:"/",message:"brak elementu głównego KEDU"}];n.namespaceURI!==D&&t.push({path:"KEDU",message:`nieoczekiwany namespace (${n.namespaceURI??"brak"})`});const r=Array.from(n.children).filter(a=>a.localName==="ZUSDRA");if(r.length===0)return t.push({path:"KEDU",message:"brak dokumentu ZUSDRA"}),t;if(r.forEach((a,o)=>{const s=r.length>1?`ZUSDRA[${o+1}]`:"ZUSDRA";let u=-1;for(const m of Array.from(a.children)){const h=m.localName;if(ve.has(h))continue;const c=ge[h];if(!c){t.push({path:`${s}/${h}`,message:"nieznany blok"});continue}const p=be.indexOf(h);p<u&&t.push({path:`${s}/${h}`,message:"blok poza kolejnością"}),u=Math.max(u,p),ee(m,c,`${s}/${h}`,t)}}),M(e,"IV","p37")&&M(e,"VI","p7")&&M(e,"IX","p2"))try{Z(e)}catch(a){t.push({path:"ZUSDRA/IX/p2",message:a.message})}return t}function Se(e){return e.replace(/\s/g,"").replace(/^PL/i,"")}function je(e){let t=0;for(const n of e)t=(t*10+(n.charCodeAt(0)-48))%97;return t}function xe(e){return/^\d{26}$/.test(e)?je(e.slice(2)+"2521"+e.slice(0,2))===1:!1}function Ee(e,t){return/^\d{10}$/.test(t)&&e.slice(-10)===t}function O(e){const t=/^(\d{2})(\d{4})(\d{4})(\d{4})(\d{4})(\d{4})(\d{4})$/.exec(e);return t?t.slice(1).join(" "):e}let i=null;function S(e,t){var r;let n=G(e);for(const a of t)n=n?Array.from(n.children).find(o=>o.localName===a)??null:null;return((r=n==null?void 0:n.textContent)==null?void 0:r.trim())??""}function A(e,t,n){const r=S(e,[t,n]);return r?L(r):0}function Ne(e){const t=Object.keys(U).map(Number).sort((c,p)=>p-c).map(c=>`<option value="${c}"${c===X?" selected":""}>${c}</option>`).join(""),n=R.map((c,p)=>`<option value="${p}">${c.label} — ${k(c.contributionGr)} zł/mies</option>`).join("");e.innerHTML=`
  ...
  `;const r=e.querySelector("#file"),a=e.querySelector("#drop"),o=e.querySelector("#load-error"),s=e.querySelector("#editor"),u=e.querySelector("#editor-empty");function m(c){e.querySelectorAll(".tab").forEach(p=>p.classList.toggle("active",p.dataset.tab===c)),e.querySelector("#tab-monthly").classList.toggle("hidden",c!=="monthly"),e.querySelector("#tab-annual").classList.toggle("hidden",c!=="annual")}e.querySelectorAll(".tab").forEach(c=>c.addEventListener("click",()=>m(c.dataset.tab??"monthly"))),e.querySelector("#goto-annual").addEventListener("click",()=>m("annual")),r.addEventListener("change",()=>{var p;const c=(p=r.files)==null?void 0:p[0];c&&h(c)}),["dragenter","dragover"].forEach(c=>a.addEventListener(c,p=>{p.preventDefault(),a.classList.add("drag")})),["dragleave","drop"].forEach(c=>a.addEventListener(c,p=>{p.preventDefault(),a.classList.remove("drag")})),a.addEventListener("drop",c=>{var f,g;const p=(g=(f=c.dataTransfer)==null?void 0:f.files)==null?void 0:g[0];p&&h(p)}),Pe(e);async function h(c){o.classList.add("hidden");try{const p=await c.text(),f=q(p);if(G(f).namespaceURI!==D)throw new Error("Nieoczekiwany namespace — spodziewano się KEDU 5.7.");const g=S(f,["XI","p13"]),z=S(f,["XI","p16"]);i={xml:p,period:S(f,["I","p2","p2"]),payerName:Re(f),nip:S(f,["II","p1"]),regon:S(f,["II","p2"]),social:A(f,"IV","p37"),health:A(f,"VI","p7"),laborFund:A(f,"VII","p3"),total:A(f,"IX","p2"),annual:z?L(z):null,revenue:g?L(g):null},Le(e),s.classList.remove("hidden"),u.classList.add("hidden"),m("monthly")}catch(p){i=null,s.classList.add("hidden"),u.classList.remove("hidden"),o.textContent=`Nie udało się wczytać pliku: ${p.message}`,o.classList.remove("hidden")}}}function Re(e){const t=S(e,["II","p6"]),n=S(e,["II","p7"]),r=S(e,["II","p8"]);return[t,[r,n].filter(Boolean).join(" ")].filter(Boolean).join(", ")}function te(e){var t,n;return(((t=e.scale)==null?void 0:t.contributionGr)??0)+(((n=e.flat)==null?void 0:n.contributionGr)??0)}function ne(e,t){var n,r;ce(e,{taxScale:(n=t.scale)==null?void 0:n.contributionGr,flatTax:(r=t.flat)==null?void 0:r.contributionGr}),de(e,{scale:t.scale,flat:t.flat})}function Le(e){if(!i)return;const t=e.querySelector("#meta"),n=[i.nip?`NIP ${i.nip}`:"",i.regon?`REGON ${i.regon}`:"",i.period?`okres ${i.period}`:""].filter(Boolean);t.innerHTML=`
    <div class="meta-firma"><strong>${i.payerName||"płatnik"}</strong></div>
    <div class="meta-id">${n.join(" · ")}</div>
  `,qe(e);const r=Te(e),a=e.querySelector("#min-wage"),o=e.querySelector("#tax-scale-active"),s=e.querySelector("#tax-scale-amount"),u=e.querySelector("#tax-scale-hint"),m=e.querySelector("#flat-tax-active"),h=e.querySelector("#flat-tax-amount"),c=e.querySelector("#flat-tax-hint"),p=e.querySelector("#input-error"),f=e.querySelector("#preview"),g=e.querySelector("#download"),z=he(i.period);if(e.querySelector("#april-warn").classList.toggle("hidden",!z),e.querySelector("#monthly-edit").classList.toggle("hidden",z),e.querySelector("#monthly-projection").classList.toggle("hidden",z),z)return;function d(){o.checked||(s.value=""),m.checked||(h.value=""),s.disabled=!o.checked,h.disabled=!m.checked}function w(){const l=L(a.value);if(l<T)throw new Error(`Minimalne wynagrodzenie nie może być mniejsze niż ${k(T)} zł`);return l}function y(l,b,E,re){if(!l)return null;const F=b.trim()===""?0:L(b),{podstawaGr:oe,contributionGr:ie}=pe(E,F,re);return{incomeGr:F,podstawaGr:oe,contributionGr:ie}}function v(){const l=w();return{minimumGr:J(l),minWageGr:l,scale:y(o.checked,s.value,"scale",l),flat:y(m.checked,h.value,"flat",l)}}function x(l,b){if(!l)return`puste = minimum ${k(b)}`;const E=l.contributionGr===b?" (minimum)":"";return`podstawa ${k(l.podstawaGr)} → składka ${k(l.contributionGr)}${E}`}function I(l){f.innerHTML="",g.disabled=!0,p.textContent=l,p.classList.remove("hidden")}function $(){if(!i)return;p.classList.add("hidden");let l;try{l=v()}catch(E){I(E.message);return}u.textContent=x(l.scale,l.minimumGr),c.textContent=x(l.flat,l.minimumGr);const b=te(l);Ge(f,b,l),Ae(e,l),r(l),g.disabled=b===0}[o,m].forEach(l=>l.addEventListener("change",()=>{d(),$()})),[a,s,h].forEach(l=>l.addEventListener("input",$)),g.addEventListener("click",()=>{let l;try{l=v()}catch(b){I(b.message);return}Ue(l)}),d(),$()}function Ge(e,t,n){if(!i)return;const r=[],a=(s,u,m,h={})=>{const c=u!==m;return`<tr class="${h.total?"total":""} ${c?"chg":""}">
      <td>${s}</td>
      <td class="val">${k(u)}</td>
      <td class="arr">→</td>
      <td class="val ${c?"after":""}">${k(m)}</td>
    </tr>`};r.push('<tr class="head"><td>Pozycja</td><td class="val">przed (zł)</td><td class="arr"></td><td class="val">po (zł)</td></tr>');const o=(s,u)=>De(`Forma XI: ${s} ☒ (dochód ${k(u.incomeGr)} · podstawa ${k(u.podstawaGr)})`,u.contributionGr);n.scale&&r.push(o("skala",n.scale)),n.flat&&r.push(o("liniówka",n.flat)),r.push(a("Składki społeczne (IV)",i.social,i.social)),r.push(a("Składka zdrowotna (VI)",i.health,i.health+t)),r.push(a("Fundusz Pracy (VII)",i.laborFund,i.laborFund)),r.push(a("Suma do zapłaty (IX)",i.total,i.total+t,{total:!0})),i.annual!==null&&r.push(a("Roczne rozliczenie zdrow. (XI)",i.annual,i.annual)),e.innerHTML=r.join("")}function Ae(e,t){if(!i)return;const n=e.querySelector("#schema-status");let r;try{const o=q(i.xml);ne(o,t),r=$e(o)}catch(o){r=[{path:"",message:o.message}]}if(r.length===0){n.className="schema-status ok",n.textContent="✓ Zgodne ze schematem KEDU 5.7";return}n.className="schema-status warn";const a=r.slice(0,5).map(o=>o.path?`${o.path}: ${o.message}`:o.message).join(" · ");n.textContent=`⚠ ${r.length} uwag względem schematu — ${a}${r.length>5?" …":""}`}function De(e,t){return`<tr class="form-xi"><td>${e}</td><td class="val" colspan="3">składka ${k(t)}</td></tr>`}const ae="dra.nrs";function Me(){try{return localStorage.getItem(ae)??""}catch{return""}}function Ce(e){try{localStorage.setItem(ae,e)}catch{}}function Te(e){const t=e.querySelector("#proj-bracket"),n=e.querySelector("#proj-bracket-row"),r=e.querySelector("#proj-title"),a=e.querySelector("#proj-note"),o=e.querySelector("#proj-table"),s=e.querySelector("#proj-transfer"),u=e.querySelector("#nrs-input"),m=e.querySelector("#nrs-status");if(i&&i.revenue!==null){const d=Q(i.revenue);t.value=String(R.indexOf(d))}const h=Me();h&&!u.value&&(u.value=O(h));let c=null;function p(){const d=Se(u.value),w=d==="",y=xe(d);return{nrb:d,valid:y,matches:y&&Ee(d,(i==null?void 0:i.nip)??""),empty:w}}function f(d){if(d&&(d.scale||d.flat)){const y=[d.scale&&"skala",d.flat&&"liniówka"].filter(Boolean).join(" + ");return{gr:te(d),label:y,form:!0}}const w=R[Number(t.value)]??R[1];return{gr:w.contributionGr,label:w.label,form:!1}}function g(){if(!i)return;const d=f(c);n.classList.toggle("hidden",d.form),r.textContent=d.form?"Prognoza przelewu (skala/liniówka)":"Prognoza przelewu (ryczałt — wyższy próg)",a.textContent=d.form?"Rzeczywisty przelew po dodaniu składki zdrowotnej za ten miesiąc (= suma do zapłaty).":"Ile zapłacisz miesięcznie, gdy wejdziesz na wyższy próg. Nie zmienia pliku — to planowanie, żeby nie zaskoczyła Cię majowa dopłata.";const w=d.form?i.health+d.gr:d.gr,y=d.form?`VI + ${d.label}`:d.label,v=i.social+i.laborFund+w;o.innerHTML=`
    ...
    `;const x=i.period||"—",{nrb:I,valid:$}=p(),l=$?`<div class="row"><span>Rachunek ZUS (NRS)</span><strong>${O(I)}</strong></div>`:"";s.innerHTML=`
      <div class="row"><span>Kwota przelewu</span><strong>${k(v)} zł</strong></div>
      ${l}
      <div class="row"><span>Opis (opcjonalny)</span><span>Składki ZUS ${x}</span></div>
    ...
    `}function z(){const{nrb:d,valid:w,matches:y,empty:v}=p();w&&Ce(d),v?m.textContent="wklej raz — zapamiętamy w przeglądarce":w?y?m.textContent="✓ poprawny, zapisany":m.textContent="⚠ ostatnie 10 cyfr ≠ NIP z pliku — sprawdź":m.textContent="⚠ niepoprawny numer (26 cyfr / cyfra kontrolna)",g()}return t.addEventListener("change",g),u.addEventListener("input",z),z(),d=>{c=d,g()}}function qe(e){if(!i)return;const t=e.querySelector("#brackets"),n=i.revenue!==null?Q(i.revenue):null,r='<tr class="head"><td>Próg (roczny przychód)</td><td class="val">Składka mies. (zł)</td></tr>',a=R.map(o=>{const s=n===o;return`<tr class="${s?"sel":""}">
      <td>${o.label}${s?' <span class="badge">ten DRA</span>':""}</td>
      <td class="val">${k(o.contributionGr)}</td>
    </tr>`}).join("");t.innerHTML=r+a}function Pe(e){const t=e.querySelector("#annual-form"),n=e.querySelector("#annual-income"),r=e.querySelector("#annual-months"),a=e.querySelector("#annual-year"),o=e.querySelector("#annual-year-info"),s=e.querySelector("#annual-files"),u=e.querySelector("#annual-files-info"),m=e.querySelector("#annual-paid"),h=e.querySelector("#annual-error"),c=e.querySelector("#annual-result");function p(){return Number(a.value)||X}function f(){h.classList.add("hidden");const z=p(),d=me(z);o.textContent=`min. ${k(d)}/mies · ${_(z)}`;try{const w=n.value.trim()===""?0:L(n.value),y=Number(r.value.trim());if(!Number.isInteger(y)||y<1||y>12)throw new Error("Liczba miesięcy musi być z zakresu 1–12");const v=m.value.trim()===""?0:L(m.value);if(v<0)throw new Error("Wpłacone zaliczki nie mogą być ujemne");const x=fe(t.value,w,d,y),I=ye(x,v),$=I.balanceGr<0,l=I.balanceGr===0,b=l?"Rozliczone (saldo 0)":$?"Nadpłata (do zwrotu)":"Dopłata (do 20 maja)";c.innerHTML=`
      ...
      `}catch(w){c.innerHTML="",h.textContent=w.message,h.classList.remove("hidden")}}async function g(){const z=Array.from(s.files??[]);if(z.length===0)return;const d=p(),w=[];let y=0;const v=[];for(const l of z)try{const b=q(await l.text()),E=S(b,["I","p2","p2"]);if(!ke(E,d)){v.push(E||l.name);continue}w.push({period:E,identifier:Number(S(b,["I","p2","p1"])||"0"),healthGr:A(b,"VI","p7")})}catch{y+=1}const{totalGr:x,months:I}=ze(w);m.value=k(x),I.length>0&&(r.value=String(I.length));const $=[];I.length&&$.push(`${I.length}/12 mies. (${_(d)})`),v.length&&$.push(`poza rokiem: ${v.join(", ")}`),y&&$.push(`${y} plik(ów) nie wczytano`),u.textContent=$.length?$.join(" · "):"nie wczytano poprawnych DRA",f()}[t,n,r,m,a].forEach(z=>{z.addEventListener("input",f),z.addEventListener("change",f)}),s.addEventListener("change",()=>void g()),f()}function Ue(e){if(!i)return;const t=q(i.xml);ne(t,e);const n=ue(t),r=new Blob([n],{type:"application/xml"}),a=URL.createObjectURL(r),o=document.createElement("a");o.href=a;const s=i.period||"DRA";o.download=`DRA_${s}_zdrowotna.xml`,o.click(),URL.revokeObjectURL(a)}const K=document.querySelector("#app");K&&Ne(K);
