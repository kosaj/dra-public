...
`}const F=.09,K=.049,k=480600;function C(e){return Math.round(e*F)}const j=[{label:"przychód do 60 000 zł",revenueFromGr:0,revenueToGr:6e6,contributionGr:49835},{label:"przychód 60 000 – 300 000 zł",revenueFromGr:6e6,revenueToGr:3e7,contributionGr:83058},{label:"przychód powyżej 300 000 zł",revenueFromGr:3e7,revenueToGr:null,contributionGr:149504}];function O(e){return j.find(t=>e>=t.revenueFromGr&&(t.revenueToGr===null||e<=t.revenueToGr))??j[j.length-1]}function Z(e,t,n){if(!e)return 0;const a=t.trim();return a===""?n:f(a)}function J(e,t,n){const a=Z(e,t,n);if(e&&t.trim()!==""&&a<n)throw new Error(`kwota nie może być niższa niż minimum ${p(n)} zł`);return a}function Q(e,t,n,a){const o=Math.max(0,Math.round(t*(e==="scale"?F:K))),i=C(n)*a;return Math.max(o,i)}function Y(e,t){return{dueGr:e,paidGr:t,balanceGr:e-t}}let c=null;function y(e,t){var a;let n=E(e);for(const r of t)n=n?Array.from(n.children).find(o=>o.localName===r)??null:null;return((a=n==null?void 0:n.textContent)==null?void 0:a.trim())??""}function T(e,t,n){const a=y(e,[t,n]);return a?f(a):0}function ee(e){e.innerHTML=`
    ...
    <div class="card info">
      ...
      <p class="docs">Dokumentacja ZUS:
        <a href="https://bip.zus.pl/inne/wymagania-dla-oprogramowania-interfejsowego/dokumenty-ubezpieczeniowe" target="_blank" rel="noopener noreferrer">wymagania dla oprogramowania interfejsowego — dokumenty ubezpieczeniowe (KEDU)</a>.</p>
    </div>
